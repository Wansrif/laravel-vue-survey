...
<template>
  <PageComponent>
    ...
    <!-- Skeleton Loading -->
    <div v-if="surveyLoading" class="shadow sm:overflow-hidden">
      <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
        <div
          class="bg-gray-200 h-40 w-64 dark:bg-gray-700 animate-pulse rounded-lg"
        ></div>
        <div
          class="bg-gray-200 h-8 dark:bg-gray-700 animate-pulse rounded-lg"
        ></div>
        <div
          class="bg-gray-200 h-8 dark:bg-gray-700 animate-pulse rounded-lg"
        ></div>
        ...
        <div class="flex justify-end">
          <div
            class="bg-gray-200 h-8 w-64 dark:bg-gray-700 animate-pulse rounded-lg"
          ></div>
        </div>
      </div>
    </div>
