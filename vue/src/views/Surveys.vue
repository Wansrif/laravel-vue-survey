...
import SkeletonSurveyListItem from "../components/SkeletonSurveyListItem.vue";
...
<template>
  <PageComponent>
    ...
    <SkeletonSurveyListItem v-if="surveys.loading" />
    ...
    <div v-else>
      <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3">
        <SurveyListItem
          ...
          :style="{ animationDelay: `${survey.id * 0.1}s` }"
